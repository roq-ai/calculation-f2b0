...
import { getScores, deleteScoreById } from 'apiSdk/scores';
...
function ScoreListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('score', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/scores/view/${id}`);
    }
  };
    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('score', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/scores/create`} passHref legacyBehavior>
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>
                      {hasAccess('score', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                        <NextLink href={`/scores/edit/${record.id}`} passHref legacyBehavior>
                          <Button
